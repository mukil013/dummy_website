...
export default function About() {
  return (
    <div className='h-screen w-full flex flex-col justify-center items-center gap-4'>
      <h1 className='text-4xl'>This is About Page</h1><br />
      ...
      Quia voluptate dolorem quae nihil, autem aliquid odio natus temporibus magni, provident facilis vitae impedit iusto sequi expedita repudiandae ipsum aperiam nostrum vel. Minima itaque illum fugiat magni blanditiis tenetur!
      Iusto veritatis maiores sit quibusdam, eaque sequi deserunt aperiam exercitationem? Qui sequi ratione, maxime aliquid labore eligendi quibusdam ducimus veritatis modi iure? Minima amet nam corporis, maiores rem quis optio!
      Dolore quasi dignissimos alias nihil ex nulla, totam deleniti earum aliquam officia nostrum molestias corporis tempora sed provident natus animi cupiditate ad quaerat voluptas consectetur rem. Unde exercitationem consectetur reiciendis.
      Iste voluptatem recusandae, doloribus numquam delectus aspernatur quia dicta neque cupiditate eum sit porro possimus fugiat maiores vel? Dolores voluptas sapiente nulla explicabo laudantium autem qui praesentium nihil quae voluptate!
